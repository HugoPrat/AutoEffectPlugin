/*
  ==============================================================================
    ...
    StandaloneApp.h
    Created: 26 Jan 2022 12:43:21pm
    Author:  Hugo PRAT
...
//#ifdef JUCE_USE_CUSTOM_PLUGIN_STANDALONE_APP
...
public:
    ...
    */
    ...
    /** get AudioDevice Manager*/
    AudioDeviceManager &getAudioDeviceManager() { return deviceManager; }
    
    /** Shows an audio properties dialog box modally. */
    void showAudioSettingsDialog(Rectangle<int> bounds)
    {
        ...
        window->getContentComponent()->setBounds(bounds);
        window->getContentComponent()->getBounds();
    }
